...
load(['Init_LHS_Ca_Cb_HV',HV,'.mat'],'ResLVVol','ResLVStrain','Cab','Times')
ind = (ResLVVol ~= 0);
...
cfse = gpcf_sexp('lengthScale',mn(2:3),...
...
%     hold off
    ...
    As = x_new(1)*mpara.As;
    Bs = x_new(2)*mpara.Bs; 
    Afs = x_new(1)*mpara.Afs;
    Bfs = x_new(2)*mpara.Bfs;
    ...
    save(['BayOpt_Ca_Cb_HV',HV,'.mat'],'Cab',...
