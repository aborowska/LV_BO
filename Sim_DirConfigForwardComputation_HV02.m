...
%     abaqusDir = 'not defined yet';
    if ~isempty(strfind(pwd,'ab507t'))
        abaqusDir = 'C:/Users/ab507t/ownCloud2/HaoGao/Alan_Simulator/AbaqusWorkingSpace/HV02';
    else
       abaqusDir = 'C:/Users/ancal/ownCloud2/HaoGao/Alan_Simulator/AbaqusWorkingSpace/HV02';
    end
elseif isunix
    abaqusDir = '/home/staff1/aborowska/LVOptimization/Alan_Simulator_new/AbaqusWorkingSpace/HV02';
end
...
%     LVSegDir =          'not defined yet';
    if ~isempty(strfind(pwd,'ab507t'))
        ...
        abaqusDir_preMesh = 'C:/Uers/ancal/ownCloud2/HaoGao/HV02/earlyDiastole';
    end
    LVSegDir = abaqusDir_preMesh;
elseif isunix
    abaqusDir_preMesh = '/xlwork3/hgao/segmentationResults/Results_done_HG/HV02/earlyDiastole';
    LVSegDir = abaqusDir_preMesh;
end
