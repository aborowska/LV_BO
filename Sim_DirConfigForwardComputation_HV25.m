...
path(path, '../LVModelSimulator/optimizationFunctions');
path(path, '../LVModelSimulator/meshRelated');
path(path, '../LVModelSimulator/HexMeshProcessing');
path(path, '../LVModelSimulator/PCAReconstruction');
path(path, '../LVModelSimulator/tools');

disp('running HV25 subject!');
...
%     abaqusDir = 'not defined yet';
    if ~isempty(strfind(pwd,'ab507t'))
        abaqusDir = 'C:/Users/ab507t/ownCloud2/HaoGao/Alan_Simulator/AbaqusWorkingSpace/HV25';
    else
       abaqusDir = 'C:/Users/ancal/ownCloud2/HaoGao/Alan_Simulator/AbaqusWorkingSpace/HV25';
    end
elseif isunix
    abaqusDir = '/home/staff1/aborowska/LVOptimization/Alan_Simulator_new/AbaqusWorkingSpace/HV25';
end
...
cd(abaqusDir);
parameterOptimization; % %%%parameters, this is from Wang's paper: mpara struct
cd(workingDir);
...
%     LVSegDir =          'not defined yet';
    if ~isempty(strfind(pwd,'ab507t'))
        abaqusDir_preMesh = 'C:/Users/ab507t/ownCloud2/HaoGao/earlyDiastole';
    else
        abaqusDir_preMesh = 'C:/Uers/ancal/ownCloud2/HaoGao/HV25/earlyDiastole';
    end
    LVSegDir = abaqusDir_preMesh;
elseif isunix
    abaqusDir_preMesh = '/xlwork3/hgao/segmentationResults/Results_done_HG/HV25/earlyDiastole';
    LVSegDir = abaqusDir_preMesh;
end
...
options.cpunumber = 6; %%using how many cpu numbers, default value can be overwrote 
